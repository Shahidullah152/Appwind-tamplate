...
function Blog1() {
  return (
    <>
      {/* hero  */}
      <div className="w-full h-auto bg-HeroBG-img mt-12 rounded-2xl py-20 mb-32 sm:mb-10">
        <div>
      ...
      <div className="flex flex-wrap items-center justify-center gap-10">
        <div className="relative  -z-10 w-full md:w-[45%]  ">
          ...
          <div className="absolute  rounded-xl bottom-0 h-auto md:h-32 left-0 w-full px-8  bg-black/50 backdrop-blur-sm p-2 shadow-2xl overflow-hidden">
      ...
      <div className="flex items-center justify-center my-24">
        <div className="flex items-center justify-between w-[100%] md:w-[50%] lg:w-[40%] bg-HeroBG-img bg-cover py-4 px-6 rounded-lg">
          <span className="w-8 h-8 md:w-10 sm:h-10 bg-white rounded-lg flex items-center justify-center hover:bg-[#8B5cf5] transition-all duration-200 ease-in hover:text-white cursor-pointer">
            <FaArrowLeft />
          </span>
          <span className="w-8 h-8 md:w-10 sm:h-10 bg-white rounded-lg flex items-center justify-center hover:bg-[#8B5cf5] transition-all duration-200 ease-in hover:text-white cursor-pointer font-sans font-medium">
            1
          </span>
          <span className="w-8 h-8 md:w-10 sm:h-10 bg-white rounded-lg flex items-center justify-center hover:bg-[#8B5cf5] transition-all duration-200 ease-in hover:text-white cursor-pointer font-sans font-medium">
            ...
